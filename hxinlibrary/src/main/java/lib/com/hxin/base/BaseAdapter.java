...
import lib.com.hxin.R;
import lib.com.hxin.animation.AlphaInAnimation;
import lib.com.hxin.animation.CustomAnimation;
import lib.com.hxin.animation.ScaleInAnimation;
import lib.com.hxin.animation.SlideInBottomAnimation;
import lib.com.hxin.animation.SlideInLeftAnimation;
import lib.com.hxin.animation.SlideInRightAnimation;

/**
 * Created by YongChen.Yu on 2017/7/21.
 */
...
public abstract class BaseAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        BaseViewHolder hxViewHolder = null;
        this.mContext = parent.getContext();
        this.mLayoutInflater = LayoutInflater.from(mContext);
        switch (viewType) {
            case LOADING_VIEW:
                hxViewHolder = getLoadingView(parent);
                initItemClickListener(hxViewHolder);
                break;
            case HEADER_VIEW:
                hxViewHolder = new BaseViewHolder(mContext, mHeaderView);
                break;
            case EMPTY_VIEW:
                hxViewHolder = new BaseViewHolder(mContext, mEmptyView);
                break;
            case FOOTER_VIEW:
                hxViewHolder = new BaseViewHolder(mContext, mFooterView);
                break;
            default:
                hxViewHolder = onCreateDefViewHolder(parent, viewType);
                initItemClickListener(hxViewHolder);
        }
        return hxViewHolder;
    ...
    /**
     * When the current adapter is empty, the HxAdapter can display a special view
